  ...
  Future<void> _fetch({bool silent = false}) async {
    ...
    try {
      ...
      final data = await ref
          ...
          .get('/orders/recent-menu', query: {'after_id': _lastSeenId ?? 0});
      ...
      if (_lastSeenId != null && incremental.isNotEmpty && mounted && silent) {
      ...
      final newCount = list.where((o) => o['pos_status'] == 'new').length;
          ...
          child: Column(
            ...
            children: [
              HsPageHeader(
                ...
                title: 'طلبات المنيو',
                subtitle: 'طلبات QR والمنيو الواردة إلى هذا الجهاز.',
                trailing: Row(
                  ...
                  children: [
                    ...
                    FilterChip(
                      label: Text(
                        _soundEnabled ? 'الصوت: تشغيل' : 'الصوت: إيقاف',
                      ),
