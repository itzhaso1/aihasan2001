@php
    $sections = [
        ...
        'المبيعات' => [
            ...
            ['label' => 'عروض الأسعار', 'route' => 'workspace.finance.quotes.index', 'active' => 'workspace.finance.quotes.*'],
            ['label' => 'الفواتير', 'route' => 'workspace.finance.invoices.index', 'active' => 'workspace.finance.invoices.*'],
            ['label' => 'الدفعات', 'route' => 'workspace.finance.payments.index', 'active' => 'workspace.finance.payments.*'],
            ['label' => 'الإيصالات', 'route' => 'workspace.finance.receipts.index', 'active' => 'workspace.finance.receipts.*'],
        ...
        'المحاسبة والضرائب' => [
            ...
            ['label' => 'تصدير CSV', 'route' => 'workspace.finance.exports.index', 'active' => 'workspace.finance.exports.*'],
